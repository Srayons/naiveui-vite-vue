...
const routes = [
  ...
  },
  {
    ...
    meta: { title: '控制台' },
    children: [
      { path: '/wellcome', name: 'wellcome', component: () => import("@/views/admin/wellcome.vue"), meta: { title: '控制台' } },
      { path: '/test2', name: 'test2', component: () => import("@/views/admin/menu/test2.vue"), meta: { title: '测试页面2' } },
      { path: '/test3', name: 'test3', component: () => import("@/views/admin/menu/test3.vue"), meta: { title: '测试页面3' } },
      { path: '/test4', name: 'test4', component: () => import("@/views/admin/menu/test4.vue"), meta: { title: '测试页面4' } },
